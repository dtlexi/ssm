                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li class="${pageInfo.pageNum==1?"disabled":""}">
                                ...
                                <c:if test="${pageInfo.pageNum!=1}">
                                    <a href="${pageContext.request.contextPath}/product/find/1/${pageInfo.pageSize}.do"
                            ...
                            <li class="${pageInfo.pageNum==1?"disabled":""}">
                                ...
                                <c:if test="${pageInfo.pageNum!=1}">
                                    <a href="${pageContext.request.contextPath}/product/find/${pageInfo.pageNum-1}/${pageInfo.pageSize}.do"
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="i" step="1">
                                <li class="${pageInfo.pageNum==i?"active":""}"><a
                                        href="${pageContext.request.contextPath}/product/find/${i}/${pageInfo.pageSize}.do">${i}</a>
                                </li>
                            </c:forEach>
                            <li class="${pageInfo.pageNum==pageInfo.pages?"disabled":""}">
                                ...
                                <c:if test="${pageInfo.pageNum!=pageInfo.pages}">
                                    <a href="${pageContext.request.contextPath}/product/find/${pageInfo.pageNum+1}/${pageInfo.pageSize}.do">下一页</a>
                                </c:if>
                            </li>
                            <li class="${pageInfo.pageNum==pageInfo.pages?"disabled":""}">
                                <c:if test="${pageInfo.pageNum==pageInfo.pages}">
                            ...
                            <c:if test="${pageInfo.pageNum!=pageInfo.pages}">
                                <a href="${pageContext.request.contextPath}/product/find/${pageInfo.pages}/${pageInfo.pageSize}.do"
                                   aria-label="Next">尾页</a></li>
                            </c:if>
                        </ul>
                    </div>
